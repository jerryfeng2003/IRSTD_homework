...
def LLoss(pred, target):
    ...
    loss = loss+(1 - length_loss + angle_loss).mean()
...
# x=torch.randn(4,3,32,32).to(torch.device('cuda'))
# y=torch.randn(4,3,32,32).to(torch.device('cuda'))
# print(LLoss_origin(x,y)-LLoss(x,y))
# print(LLoss_origin(x,y))
# print(LLoss(x,y))